        ...
        <div className={styles["index-content-body"]}>
          <Card className={styles["chart-card"]}>
            <Spin spinning={loading} tip="加载数据中...">
              <div ref={chartRef} className={styles["index-chart"]} />
            </Spin>
          </Card>
            ...
            <Card className={styles["data-card"]}>
              ...
              <div className={styles["data-grid"]}>
                <div className={styles["data-item"]}>
                  ...
                  <Text className={styles["data-value"]}>
                    {indexData[indexData.length - 1].close.toFixed(2)}
                  </Text>
                </div>
                <div className={styles["data-item"]}>
                  <Text strong>最高价:</Text>
                  <Text className={styles["data-value"]}>
                    {Math.max(...indexData.map((item) => item.high)).toFixed(2)}
                  </Text>
                </div>
                <div className={styles["data-item"]}>
                  <Text strong>最低价:</Text>
                  <Text className={styles["data-value"]}>
                    {Math.min(...indexData.map((item) => item.low)).toFixed(2)}
                  </Text>
                </div>
                <div className={styles["data-item"]}>
                  <Text strong>成交量:</Text>
                  <Text className={styles["data-value"]}>
                    {indexData[indexData.length - 1].volume.toLocaleString()}
                  </Text>
                </div>
              </div>
            </Card>
